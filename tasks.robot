...
Fill and submit the form
    ...
    Sleep    4s
    Capture Element Screenshot    id:robot-preview-image    ${OUTPUT_DIR}${/}sales_results${/}sales_summary-${person}[Order number].png
    ...
    ${final}=    Add Watermark Image To Pdf    ${OUTPUT_DIR}${/}sales_results${/}sales_summary-${person}[Order number].png
